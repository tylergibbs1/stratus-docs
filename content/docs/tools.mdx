...
<Callout type="info">
Stratus handles the full tool loop automatically - Zod validation, parallel execution, error recovery, and 429 retries. No `JSON.parse()`, no dispatch tables, no manual message management. See the [Agentic Tool Use guide](/guides/agentic-tool-use) for the full picture.
</Callout>
