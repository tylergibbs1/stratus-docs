...
Stratus supports multimodal input through `ContentPart` arrays. Send text, images, or both to any agent.

- **Text parts** — `{ type: "text", text: "..." }`
- **Image parts** — `{ type: "image_url", image_url: { url: "...", detail?: "auto" | "low" | "high" } }`
...
- [Streaming](/docs/streaming) — Stream responses token by token
- [Structured Output](/docs/structured-output) — Parse model output into typed objects
